...
// [[Rcpp::export]]
map<std::string, int> breadthFirstSearch(const std::string actorName) {
  
  std::ifstream datafile("/Users/Dekun/Documents/Demo/kevin-bacon.dat");      // change to the correct location
...
/*** R
breadthFirstSearch('Kevin Bacon')
*/
